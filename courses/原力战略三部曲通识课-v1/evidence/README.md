...
- `B0-原力创业四关-证据计划.md`：B轴总览课的正典依据、教学投影边界、外部证据需求与真实试讲指标。

当前状态：

```text
正典证据：verified
B0 教学投影：approved framework / Soul Draft PR
...
A1、B0、B1、C4已完成证据结构规划；外部论文、数据与企业案例仍待逐条核验。
...
- B0 是教学导航层，不是第五个正典模块。
- “两账”是价值路线，不得写成完整心理账户体系的学术分类。
- B4永远使用虚、实、入、出四大控制权口径。
- 飞轮是强化机制，原力母体是生成源头，不得并列为壁垒。
